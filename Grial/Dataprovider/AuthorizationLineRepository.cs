...
namespace UXDivers.Artina.Grial.Dataprovider
{
    ...
    {
        public string StringTrcType { get; set; }
    ...
    public class AuthorizationLineRepository
    {
        ...
        private static List<AuthorizationLine> AllLines()
        {
            ...
            foreach (var counterpart in counterparts)
            {
                ...
                lineSituation.Add(new Situation() { StringTrcType = "LC", LimitAmount = random.Next(lmin, lmax), OutstandingAmount = random.Next(omin, omax) });
                lineSituation.Add(new Situation() { StringTrcType = "LG", LimitAmount = random.Next(lmin, lmax), OutstandingAmount = random.Next(omin, omax) });

                lineSituation.Add(new Situation() { StringTrcType = "UnSpecificIR", LimitAmount = random.Next(lmin, lmax), OutstandingAmount = random.Next(omin, omax) });

                lineSituation.Add(new Situation() { StringTrcType = "Unspecific", LimitAmount = random.Next(lmin, lmax), OutstandingAmount = random.Next(omin, omax) });
